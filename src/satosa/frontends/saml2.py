...
subject_type_map = {
    NAMEID_FORMAT_TRANSIENT: NAMEID_FORMAT_EMAILADDRESS,
    NAMEID_FORMAT_PERSISTENT: NAMEID_FORMAT_EMAILADDRESS,
    NAMEID_FORMAT_EMAILADDRESS: NAMEID_FORMAT_EMAILADDRESS,
    NAMEID_FORMAT_UNSPECIFIED: NAMEID_FORMAT_EMAILADDRESS,
    "public": NAMEID_FORMAT_EMAILADDRESS,
    "pairwise": NAMEID_FORMAT_EMAILADDRESS,
}


def subject_type_to_saml_nameid_format(subject_type):
    return subject_type_map.get(subject_type, NAMEID_FORMAT_EMAILADDRESS)
